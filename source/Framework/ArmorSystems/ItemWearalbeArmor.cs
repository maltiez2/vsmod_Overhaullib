...
public class ItemWearableArmor : ItemWearable
{
    ...
    public override void OnCreatedByCrafting(ItemSlot[] allInputSlots, ItemSlot outputSlot, IRecipeBase byRecipe)
    {
        ...
        if (outputSlot is not DummySlot)
        {
            ...
            {
                CalculateRepairValueProperly(allInputSlots, outputSlot, out float repairValue, out int matCostPerMatType);
    ...
    protected virtual int GetInputRepairCount(ItemSlot[] inputSlots)
    {
